...
echo
echo Continue to create GitHub TAP GitOps Repo tap-gitops-a3solo3
echo     https://github.com/tfynes-pivotal/tap-gitops-a3solo3
echo
...
git add .
git commit -am "."
gh repo create tap-gitops-a3solo3 --private
git remote add origin https://github.com/tfynes-pivotal/tap-gitops-a3solo3
git branch -M main
